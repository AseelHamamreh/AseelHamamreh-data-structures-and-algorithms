...
const containsW = (str) => {
  // Solution code here...
  const myString = /w/;
  const matching = str.match(myString);
  if (matching){
    return true;
  }
  else {
...
// Solution code here...
// const myNumber = /[0-9]/;
// const matching = input.match(myNumber);
// if (matching ){
//   return true;
// }
// else {
...
const containsWorld = (input) => {
  ...
  const matching = input.match(myString);
  if (matching){
    return true;
  }
  else {
...
const isCapitalized = (str) => {
  // Solution code here...
  const capital = /\b[A-Z][a-z]+/g;
  const matching = str.match(capital) || [];
  if (matching){
    return matching;
  }
};
...
const citiesAtoJ = (arr) => arr.filter(input=>/^[A-J]/.test(input));
  // Solution code here...
